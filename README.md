...
In this project, i will be analyzing the data for a fantasy game called Heroes of Pymoli.
...
* Identify the the top 5 spenders in the game by total purchase value, then list:
  * SN
  * Purchase Count
  * Average Purchase Price
  * Total Purchase Value
